              ...
              <tr @click="selectRow(props.index, props.item)"
                ...
                <td align="center">
                  <a @click="updateApp(props.item.name, props.item.profile)">
                    <v-icon :id="'edit__' + props.item.name + '__' + props.item.profile" color="blue">fas fa-edit
                    </v-icon>
                  </a>
                  <a @click="deleteApp(props.item.name, props.item.profile)">
                    <v-icon :id="'delete__' + props.item.name + '__' + props.item.profile" color="red">fas fa-trash-alt
                    </v-icon>
                  </a>
